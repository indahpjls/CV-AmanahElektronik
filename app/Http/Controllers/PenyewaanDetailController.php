...
class PenyewaanDetailController extends Controller
{
    ...
    {
        $penyewaan_detail = $this->penyewaandetailModel->get_penyewaan_detail();
    ...
    {
        $penyewaan_detail = PenyewaanDetailModel::find($id);
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $penyewaan_detail = $this->penyewaandetailModel->create_penyewaan_detail($validator->validated());
            return response()->json([
                'status' => 201,
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            $penyewaan_detail = $this->penyewaandetailModel->update_penyewaan_detail($validator->validated(), $id);
            return response()->json([
                'status' => 200,
    ...
    {
        $penyewaan_detail = $this->penyewaandetailModel->delete_penyewaan_detail($id);
        return response()->json([
            'status' => 200,
